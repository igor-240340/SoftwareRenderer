...
// При этом, поскольку Z-компоненты мы оставили истинными, трёхмерные образы точек A'' и B'' в общем случае не совпадают с точками A и B.
// Но при этом они лежат в тех же Z-плоскостях.
// 
