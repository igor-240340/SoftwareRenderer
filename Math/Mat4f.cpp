...
Mat4f Mat4f::create_scale_x(float scale) {
	Mat4f mat_scale_x{};

	mat_scale_x.data[0] = scale;

	return mat_scale_x;
}

Mat4f Mat4f::create_scale_y(float scale) {
	Mat4f mat_scale_y{};

	mat_scale_y.data[5] = scale;

	return mat_scale_y;
}

Mat4f Mat4f::create_scale_z(float scale) {
	Mat4f mat_scale_z{};

	mat_scale_z.data[10] = scale;
